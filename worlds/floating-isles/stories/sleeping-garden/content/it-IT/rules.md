...
- Costruite con i mattoncini e le cose di casa gli oggetti che compaiono (una
  chiave, un fiore, un ponte) man mano che giocate. Qualsiasi cosa può essere
  qualsiasi cosa.
...
- **Combinare due magie** una volta per tappa per superare la sfida senza alcun
  tiro (per esempio Luce e Voce, oppure Crescita e Cambiamento, che agiscono come
  una sola).
...
Il Cuore del Giardino non è una battaglia. Il "cattivo" è il Folletto Solitario,
che ha addormentato il giardino solo perché desiderava un amico. L'avventura si
vince quando i bambini gli offrono la loro amicizia. Lasciate che quel momento
arrivi con dolcezza; è la cosa più importante di tutte. Guardate la pagina degli
enigmi per sapere come giocare il cuore, e per le soluzioni delle tre tappe.
