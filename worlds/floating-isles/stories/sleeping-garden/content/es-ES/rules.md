...
- Construid con piezas y cosas de casa los objetos que vayan apareciendo (una
  llave, una flor, un puente) a medida que jugáis. Cualquier cosa puede ser
  cualquier cosa.
- Tened cerca vuestros dados y la tabla de bandas y dados del final del kit.

## Bandas de dificultad, no dados

Los retos nunca piden un dado concreto. En su lugar, cada uno tiene una banda:
**Fácil**, **Normal** o **Difícil**. Cuando los jugadores intentan algo, mirad la
banda en la tabla de bandas y dados del kit, que os dice el número que hay que
igualar o superar con los dados que tengáis en casa. Todos los retos de esta
historia se pueden jugar con un solo dado corriente, y los juegos de dados más
ricos solo hacen que todo parezca más grandioso.

## La regla de oro: aquí nadie pierde

Una tirada fallida nunca es una derrota. Es un desvío hacia otro camino. Cuando
...
y cuando se ayudan entre ellos. Así nadie se queda sin estrellas mucho rato, y
...
todo el juego es que juntos se llega más lejos.

## La sorpresa

En cada parada, una vez, los jugadores pueden tirar para una sorpresa y vosotros
leéis el verso que toque. Usad el dado que la tabla de bandas y dados indique para
las sorpresas; con un solo dado corriente, leed la línea que coincida con el número
que salga.
