...
**El reto.** La puerta está cerrada con un grueso nudo de enredaderas y no se abre
sola.
...
poner las cuatro flores en sus colores.
...
Así que el orden es **amarillo, azul, rojo, blanco**. Construid o colocad cuatro
...
la arreglen; necesita que la animen.

**Solución prevista.** Este es un momento de **Voz**. Los jugadores hablan con la
fuente y le levantan el ánimo: le cantan una canción, le cuentan un chiste o le
...
Esto es el desenlace, no un puzle, así que no hay banda ni tirada. Los jugadores
