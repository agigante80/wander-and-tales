...
braver tale than some, with a long climb, a swaying bridge by moonlight, and a great
sleeping dragon, but wisdom and kindness still win every time, and no one is ever
truly hurt.
...
- This world has no magic. Instead each hero leans on one of three qualities:
  **Wisdom** (a calm, thoughtful mind), **Courage** (a steady heart), or
...
- **Join two qualities** once per stop to pass with no roll at all (Wisdom and
  Kindness together, say, or Courage and Wisdom).
...
star. In these mountains, no hero stands alone.
