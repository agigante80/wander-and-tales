# The Firefly Lanterns: Puzzles and Solutions
...
**The challenge.** The Firefly Spirits are hiding in the dark of the Whispering Bamboo
...
**Fallback.** If the children grow restless or try to grab the lights, have **Kon the
Fox** murmur, "They come to calm hearts, not quick hands," and show them how to sit
...
explain works just as well.

**Fallback.** If they are unsure where to start, let the **red thread** show the way
(follow it bead by bead), or have **Kon the Fox** point his nose down the line with a
...
little firefly of all, but this one is too timid and hangs back, trembling. The players
may want to push or hurry it. They should not.

**Intended solution.** This is a Kindness and Courage moment. The little firefly only
needs encouragement. Any genuine, calming kindness works: speaking in a soft and steady
voice, saying "I believe in you" and "I will be right here", or reminding it how brave it
has already been tonight. When the children cheer it on gently, it gathers its courage,
flies up, and the Great Lantern blooms with the warmest light of all.

**Fallback.** If the children freeze, or try to nudge the firefly up by force, have it
...
There is no battle and no loser. When the Great Lantern lights, every lantern in the
