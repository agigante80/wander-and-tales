...
### Never address the players as "ustedes"

"Ustedes" as the everyday plural "you" is Latin American. In Spain it is reserved
for very formal address, which is wrong for a warm family game. Use "vosotros".
...
"callaos", "ayudaos". The only exception is "idos" (from "irse").
...
- **Warmth.** The voice is a kind grown-up, not a textbook. Reach for "cariño",
  "ternura", "mimos", "dulzura", "calorcito", "achuchón".
...
3. [ ] No Latin American vocabulary (coche not carro, ordenador not computadora,
   zumo not jugo, móvil not celular, patata not papa)?
4. [ ] "vale" for okay, "guay/mola" for cool, "coger" used naturally?
5. [ ] Full accents, and the accented pairs correct (qué/que, más/mas, sí/si)?
6. [ ] No em or en dashes; ranges as "3 a 5"?
7. [ ] No-lose tone: no "derrota", "fracaso", "perder" as failure?
8. [ ] Names match the es-ES canon and lexicon?
