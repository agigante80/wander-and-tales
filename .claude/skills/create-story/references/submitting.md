...
same way. The story catalogue and the README download links are generated by the
maintainer's rebuild after the story is merged, so a contributor does not regenerate
them.
