...
// the rendered trail map PNG for a story+locale (generated by `build render-maps`
// into <root>/maps and copied to /maps by prepare-assets)
export const storyMapUrl = (worldId: string, storyId: string, locale: string) => {
  const rel = `maps/${worldId}/${storyId}/map-${locale}.png`;
